# Generated by Django 4.1.1 on 2022-11-08 23:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='first.disciplina')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora', models.TimeField()),
                ('conteudo', models.TextField()),
                ('pergunta', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='first.pergunta')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
